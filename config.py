...
NUM_PEERS = 40                   # Total number of peers
...
TIMEOUT_TT = 10                 # Timeout (seconds) for waiting full block data
PERCENT_MALICIOUS = 0.4         # Fraction of nodes that are malicious (30%)
